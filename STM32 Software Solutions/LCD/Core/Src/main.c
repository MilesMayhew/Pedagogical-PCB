...
//  LCD_FillScreen_Fast(&lcd, 0xF800); // Red full screen
//  HAL_Delay(1000);
//  LCD_FillScreen_Fast(&lcd, 0x07E0); // Green full screen
//  HAL_Delay(1000);
//  LCD_FillScreen_Fast(&lcd, 0x001F); // Blue full screen
//  HAL_Delay(1000);
//  LCD_FillScreen_Fast(&lcd, 0xFFFF); // White full screen
  /* USER CODE END 2 */
